    ...
    stages {
        stage('Git Checkout') {
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/gaman5575/python-project-1.git'
            }
        }
                ...
                withCredentials([usernamePassword(credentialsId: 'git-credentials', usernameVariable: 'GIT_CREDENTIALS_USR', passwordVariable: 'GIT_CREDENTIALS_PSW'),
                    ...
                    script {
                        ...
                        sh """
                            ...
                            git clone https://${GIT_CREDENTIALS_USR}:${GIT_CREDENTIALS_PSW}@github.com/${GIT_CREDENTIALS_USR}/python-project-1.git
                            cd python-project-1
